...
from django.db.models import AutoField, PositiveIntegerField, BooleanField, CharField, TextField, EmailField, \
    DecimalField, DateField, PositiveSmallIntegerField, FloatField
...
def populate_model_with_data(model, num_records=10):
    ...
    for _ in range(num_records):
        ...
        for field in model_fields:
            ...
            elif isinstance(field, PositiveIntegerField) or isinstance(field, PositiveSmallIntegerField) or isinstance(field, FloatField):
